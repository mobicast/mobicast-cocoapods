...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_dsym "${PODS_ROOT}/GoogleAds-IMA-iOS-SDK/GoogleInteractiveMediaAds/GoogleInteractiveMediaAds.framework.dSYM"
  install_framework "${PODS_ROOT}/../../Mobicast/Framework/Mobicast.framework"
  install_dsym "${PODS_ROOT}/../../Mobicast/Framework/Mobicast.framework.dSYM"
  install_framework "${PODS_ROOT}/google-cast-sdk/GoogleCastSDK-Public-3.5.0-Release/GoogleCast.framework"
  install_dsym "${PODS_ROOT}/google-cast-sdk/GoogleCastSDK-Public-3.5.0-Release/GoogleCast.framework.dSYM"
fi
